      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/admin/dashboard" className="text-gray-700 hover:text-blue-400 font-medium">Home</Link>
            <Link href="/admin/events" className="text-gray-700 hover:text-blue-400 font-medium">Events</Link>
