...
export default function WelcomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <section className="py-24 bg-blue-400 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <Link href="/register">
            <button className="bg-white text-blue-400 px-12 py-6 rounded-full text-2xl font-bold hover:bg-gray-100 shadow-2xl">
              Sign Up Now
            </button>
          </Link>
        </div>
